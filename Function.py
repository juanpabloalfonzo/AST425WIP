...
a=galaxy_profile_plot_combined(e.loc[:,0],3,6)
...
# PC_Vector_Components=np.zeros([3,6,4,2])
# for i_2 in range(2): #Randomly samples the inputed data frame of galaxies and does PCA Analysis "2" number of times
#     a=resample(e.loc[:,0],n_samples=4)
#     b=galaxy_PCA(a,3,6)
#     PC_Vector_Components[:,:,:,i_2]=b[0]  

    
# PC_Errors_STD=np.zeros([3,6])
# #for i_galaxy in range(4):
